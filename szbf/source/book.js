var book={
	book_name:"孙子兵法",
	page_title:"《孙子兵法》 - 原文 + 总结",
	pages:[
		{
			index_title:"前言",
			title:"",
			abstract:"关于《兵法》的简介，以及我的笔记的说明",
			content:[
				"《孙子兵法》又称《孙武兵法》、《吴孙子兵法》、《孙子兵书》、《孙武兵书》等，作者为春秋时祖籍齐国乐安的吴国将军孙武，是中国现存最早的兵书，也是世界上最早的军事著作，早于克劳塞维茨《战争论》约2300年，被誉为“兵学圣典”。共有六千字左右，一共十三篇。是中国古代军事文化遗产中的璀璨瑰宝，优秀传统文化的重要组成部分，其内容博大精深，思想精邃富赡，逻辑缜密严谨，是古代军事思想精华的集中体现。《孙子兵法》被奉为兵家经典。诞生已有2500年历史，历代都有研究。李世民说“观诸兵书，无出孙武”。兵法是谋略，谋略不是小花招，而是大战略、大智慧。如今，《孙子兵法》已经走向世界。它也被翻译成多种语言，在世界军事史上也具有重要的地位。汉代版《孙子兵法》竹简1972年出土于临沂银雀山汉墓中。——《百度百科》",
				"《孙子兵法》无论在个人成长还是商业竞争中，都有非常大的用处。我在学习完之后，对生活中各种决策的理解又变得更加确定和清晰了一些。最近学完了华衫老师在「得到」上的课程《讲透孙子兵法·30讲》，把自己的笔记和原文放在这里分享给大家。",
				"华衫老师把孙子兵法的要点分析得很透彻，同时课程给出了文稿，我之所以还要自己记一些笔记，是为了方便日后的复习，毕竟没有时间每次复习都去看一遍完整的文稿，我也希望我的笔记可以帮大家快速的领悟孙子兵法所讲的内容。",
				"我笔记的顺序不是按照原文，而是以一些重要的关键词为索引。这样做是为了方便在实际应用的时候可以快速查找。有些内容用容易理解的说法又重新表述了一遍。其中第十二章《火攻篇》，是唯一在日常生活中的用处不大的一章，所以没有写到笔记中，感兴趣的朋友可以自己去学习。",
				"我给每一章都添加了摘要概括，但是并不一定覆盖了文章的全部内容，完整的内容都在我的笔记里。",
				"最后，祝大家日有长进！",
				"【公众号 · 道非常之道】"
			]
		},
		{
			index_title:"笔记",
			title:"",
			abstract:"这是我笔记的链接，为了使缩进格式看起来整齐所以只能放大查看",
			content:[
				"<a href='./source/note.html' style='font-weight: bold;color: rgba(0,0,100,0.72);'>笔记链接-文本版</a>"
			]
		},
		{
			index_title:"第一章",
			title:"始计篇",
			abstract:'这一章中的"计"指的不是计谋，而是计算，计算敌我双方的条件和环境。在战争开始前，要计算环境天气、双方是否符合道义、领导人和士兵的能力、管理的策略、是否团结一心等因素。有胜算，才战。计谋不能决定胜负，计算才能。计算之后，我们要避其锋芒，示其假象，攻其薄弱。',
			content:[
		...
		},
		{
			index_title:"第二章",
			title:"作战篇",
			abstract:"这一章讲，战争成本非常高，尤其是运输的成本，若非要开战，也要速战速决。而从敌人那里抢物资能节省大量运输成本。",
			content:[
		...
		},
		{
			index_title:"第三章",
			title:"谋攻篇",
			abstract:"这一章讲，在击败对手的同时尽可能保全对手的资源。最好不战而屈人之兵。这讲还说出了《孙子兵法》的绝对兵力原则：兵力有绝对优势的时候，才可以可以开战。最后还讲了五种可以预先判断胜负的标志。",
			content:[
		...
		},
		{
			index_title:"第四章",
			title:"军形篇",
			abstract:"这一章首先讲了想要取胜，就要先补足自己的缺点，让自己不会被击败，然后才去尝试击败对手。其次，真正厉害的人会在问题出现之前就解决问题，而不是去解燃眉之急。",
			content:[
		...
		},
		{
			index_title:"第五章",
			title:"兵势篇",
			abstract:"这一章主要讲了三个思想：1.治理的思想——分而治之。2.以正合以奇(jī)胜的思想。3.什么是势以及势的作用，为士兵造势。",
			content:[
		...
		},
		{
			index_title:"第六章",
			title:"虚实篇",
			abstract:"这一章主要讲了虚实变化的思想，包括自己的做实做虚和调动敌人使其变虚。还要注意，虚实一定是相互对应的，不可能都是实，有舍才有得。和第三章的兵力原则相呼应，一定要以实击虚，形成局部兵力优势，才可能胜利。",
			content:[
		...
		},
		{
			index_title:"第七章",
			title:"军争篇",
			abstract:"这一章讲了以迂为直的思想以及等待的重要性。讲了战争中的指挥系统的重要性。讲了如何治理士气以及利用士气。还讲了八条用兵的禁忌。",
			content:[
		...
		},
		{
			index_title:"第八章",
			title:"九变篇",
			abstract:"这一章讲了几种常见的地形该如何应对。讲了战场上五个“不为”。还讲了五种容易导致危险的将领的缺陷。",
			content:[
		...
		},
		{
			index_title:"第九章",
			title:"行军篇",
			abstract:"这一章讲了行军宿营的四种战术守则。讲了六种不要去的危险地形。讲了侦察兵的32条行动法则，包括关于地形的，关于草木动静和鸟兽活动的，关于车辙马迹人踪的，关于敌方活动、体力、心理和人际关系的。最后还讲了养兵之道。",
			content:[
		...
		},
		{
			index_title:"第十章",
			title:"地形篇",
			abstract:"这一章讲了六种地形的战术要点。讲了将领犯错导致的六大败局。讲了地形的重要性。强调了训练的重要性。讲了做好一个将领的四个要点。",
			content:[
		...
		},
		{
			index_title:"十二章",
			title:"火攻篇",
			abstract:"这一章讲了火攻的物资对象。讲了火攻的八种方法和应对的八种工具。强调了火攻比水攻有效。再次强调了慎战的思想。",
			content:[
		...
		},
		{
			index_title:"十三章",
			title:"用间篇",
			abstract:"这一章先讲了间谍的重要性，然后讲了五种间谍类型，讲了使用间谍上的花钱之道。",
			content:[
